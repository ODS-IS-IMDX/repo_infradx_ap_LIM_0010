...
| 機能名               | 機能概要                                                                                                       |
| -------------------- | -------------------------------------------------------------------------------------------------------------- |
| レイヤ情報登録 | ベクタレイヤマスタにレイヤ情報を登録し、設備データ管理マスタテーブルにテーブルを作成する。また、設備小項目×最終断面種別単位で認可パターンを最終断面認可マスタに登録する。 |
...
6. 実行ログを確認します。
    ...
    ```
    [2026-02-03 18:54:58,621] [INFO] [LIM] BPI0001:LIM_0010_レイヤ情報登録処理 開始
    [2026-02-03 18:54:58,710] [INFO] [LIM] BPI0002:LIM_0010_レイヤ情報登録処理 終了
    ```
